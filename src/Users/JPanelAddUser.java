 ...
 * @author ASUS
 */
public class JPanelAddUser extends javax.swing.JPanel {

    /** Creates new form Projects.JPanelCreateProject */
    public JPanelAddUser(JFrame jframe) {
        initComponents();
    ...
    public void addPositions(){
        try {
            ...
            while (rs.next()) {
                jComboBox1.addItem(rs.getString("PosistionName"));
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String posistion = String.valueOf(jComboBox1.getSelectedItem());
        String email = jTextField4.getText();
        String username = jTextField5.getText();
        String password = jTextField6.getText();
        try {
            String sql = "INSERT INTO members(memberName,permissionID,phoneNum,password,username,email) " + "VALUES(?,?,?,?,?,?)";
            PreparedStatement preparedStatement = myCon.prepareStatement(sql,
                    Statement.RETURN_GENERATED_KEYS);
            preparedStatement.setString(1,name);
            String findPosistionIDSQL = "SELECT * FROM posistions WHERE PosistionName='"+posistion+"'";
            ...
            preparedStatement.setString(4,hexString.toString());
