 ...
 * @author ASUS
 */
public class JPanelRemoveProject extends javax.swing.JPanel {

    /** Creates new form Projects.JPanelCreateProject */
    public JPanelRemoveProject(JFrame jframe) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            String removeSQL = "DELETE FROM projects WHERE projectName='"+projectName+"'";
